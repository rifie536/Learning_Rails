...
このディレクトリには、Day 002 の演習課題のテンプレートファイルが含まれています。
...
- `exercise1.rb` - ブロックを受け取るメソッドの作成
- `exercise2.rb` - Procを使った配列の変換
- `exercise3.rb` - Lambdaを使ったフィルタリング
- `exercise4.rb` - ProcとLambdaの違いを確認
- `exercise5.rb` - イテレータの総合演習
- `exercise6.rb` - ブロック、Proc、Lambdaを組み合わせる
...
```
day_002/exercises の演習をすべてレビューしてください
```
